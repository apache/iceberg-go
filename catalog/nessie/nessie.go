...
const (
	...
	icebergNessieSpecVersion = "0.14.1"

	keyNessieSigV4        = "nessie.sigv4-enabled"
	keyNessieSigV4Region  = "nessie.signing-region"
	keyNessieSigV4Service = "nessie.signing-name"
	keyAuthUrl            = "nessie.authorization-url"
	keyTlsSkipVerify      = "nessie.tls.skip-verify"
)
...
func init() {
	...
	catalog.Register(string(catalog.NESSIE), reg)
...
func fromProps(props iceberg.Properties) *options {
	...
	for k, v := range props {
		...
		case keyNessieSigV4Region:
			o.sigv4Region = v
		case keyNessieSigV4Service:
			o.sigv4Service = v
		case keyAuthUrl:
			u, err := url.Parse(v)
			if err != nil {
...
func toProps(o *options) iceberg.Properties {
	...
	if o.enableSigv4 {
		props[keyNessieSigV4] = "true"
		setIf(keyNessieSigV4Region, o.sigv4Region)
		setIf(keyNessieSigV4Service, o.sigv4Service)
	}
...
func (r *Catalog) createSession(ctx context.Context, opts *options) (*http.Client, error) {
	...
	session.defaultHeaders.Set("X-Client-Version", icebergNessieSpecVersion)
...
func (r *Catalog) CatalogType() catalog.Type { return catalog.NESSIE }
...
func (r *Catalog) CommitTable(ctx context.Context, tbl *table.Table, requirements []table.Requirement, updates []table.Update) (table.Metadata, string, error) {
	...
	ret, err := doPost[payload, commitTableResponse](ctx, r.baseURI, []string{"namespaces", ns, "tables", tblName},
		payload{Identifier: nessieIdentifier, Requirements: requirements, Updates: updates}, r.cl,
