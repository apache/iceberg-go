...
func runUpgrade(_ context.Context, output Output, _ catalog.Catalog, _ *UpgradeCmd) {
	output.Error(errors.New("upgrade: not yet implemented"))
	os.Exit(1)
}

func runRollback(_ context.Context, output Output, _ catalog.Catalog, _ *RollbackCmd) {
