...
`compressed-footer-lz4-cli.puffin` contains a compressed footer generated by
the independent LZ4 CLI 1.10.0 with `--content-size --no-frame-crc`. It
provides a small cross-implementation reader fixture separate from the
`pierrec/lz4` test helpers used elsewhere in the package.
